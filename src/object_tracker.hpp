...
namespace detector {
    ...
    public:
        ...
        explicit MultiTracker(const double &minTrackingQuality): _minTrackingQuality(minTrackingQuality) {
        ...
        [[nodiscard]] cv::Rect2i getObjectBbox(const dlib::correlation_tracker &tracker) const {
            auto trackedPosition = tracker.get_position();
